...
<table>
  ...
  <tr>
    ...
    <td><strong>Лазерная указка</strong><br>Показывай мышью прямо поверх живого экрана: след гаснет сам. Работает и во время созвона, и внутри выделения.</td>
  </tr>
  <tr>
    <td><strong>Окно двумя кликами</strong><br>Наведи на окно и кликни дважды, в рамке окажется ровно оно. Тройной клик берёт монитор целиком.</td>
...
| Двойной клик | Выделить окно под курсором |
| Тройной клик | Выделить монитор целиком |
...
Горячие клавиши меняются в настройках. Там же назначаются сочетания для лазерной указки, закрепления снимка, скрытия и показа всех закреплённых окон. Одиночная буква, назначенная глобальной горячей клавишей, перестанет печататься в других программах; предупреждение об этом находится рядом с полем.
