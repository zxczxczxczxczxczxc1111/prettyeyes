...
- **Инструменты.** Размытие, стрелка, линия, рамка. Размытие берёт пиксели из
  исходного кадра, поэтому два перекрывающихся пятна не превращаются в кашу.
...
- **Снимок монитора.** Отдельная комбинация снимает монитор под курсором сразу
  в буфер, без оверлея.
...
Обе комбинации меняются в настройках. По умолчанию выбран не `PrtScn`, потому
что на Windows 11 его перехватывают «Ножницы».
